  ...
  return (
    <section
      ...
      className=" bg-cover bg-bottom
       -mb-[300px]  lg:bg-no-repeat lg:bg-center lg:h-[110vh]"
    >
      <div className=" px-4 py-8 sm:px-6 sm:py-12 lg:px-24 lg:py-14 font-cambria ">
        ...
        <div
          ...
          id="team-wrapper"
          className="mt-8 grid grid-cols-2 gap-2 md:mt-10 md:grid-cols-3 md:gap-4 lg:gap-8 lg:grid-cols-3 xl:grid-cols-4 "
        >
          {data.map((i, index) => {
            return (
              <div
              ...
              >
                ...
                >
                  <div
                    ...
                    className="bg-green absolute z-10 h-36 w-36 md:h-40 md:w-40 sm:h-40 sm:w-40 lg:h-52 lg:w-52 top-2 left-2 lg:top-4 lg:left-4"
                  >
