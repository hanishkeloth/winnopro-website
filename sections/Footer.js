...
import logo from "../public/images/HeaderImages/footerLogo.png";
    ...
    <>
      <div className="w-screen-xl text-description text-white font-cambria bg-sec-blue px-4 py-8 sm:px-6 sm:py-12 lg:px-24 lg:py-14 ">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="">
              <Image src={logo} className=" object-cover w-[251px] h-[44px] " />
            </div>
            <div className="grid mt-6 text-[16px] font-medium grid-cols-2">
              {navigation.map((data) => {
                return <p>{data}</p>;
              })}
            </div>
