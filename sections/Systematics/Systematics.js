...
const Systematics = () => {
  ...
  return (
    <>
      <Head>
        <title>Systematics - Winnopro</title>
        <meta
          name="description"
          content="Learn about our systematics and how they can benefit your projects."
        />
        <meta property="og:title" content="Systematics - Winnopro" />
        <meta
